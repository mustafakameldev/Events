...
public class Tap3 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tap3 , container, false);
        listView =(ListView)rootView.findViewById(R.id.tap3LV);
        mainRef= FirebaseDatabase.getInstance().getReference().child("bad");
